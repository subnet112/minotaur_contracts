...
contract SettlementSwapSandbox is Script, StdCheats {
    ...
    function run() external {
        ...
        address settlement = address(0xdeadbeef); // mimic settlement contract address
        deal(USDC, settlement, AMOUNT_IN, true);
